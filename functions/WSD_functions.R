...
# resampling ?̊֐????????Ȃ??Ƃ????Ȃ??@?E?F?C?g?t???āB
...
# n =100, 250, ?Ńp?????[?^?????̃V?~?????[?V???????ʂ??Љ???B
# unknown parameters ??mean ?? sd 
...
# gamma?͕????̕W?{????
# s = ?????̕W?{???U???烂?[?????g????
# mu_rho, sig_rho?͑S?????????t???Ȃ??̂?0,1
# mu_g, mu_f, sig_f?Ƃ??́ATVC?Ő??肵?????̂??g???B
#
