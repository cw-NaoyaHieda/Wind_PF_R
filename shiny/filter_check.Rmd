...
renderPlot({
  p1 <- ggplot(data = data.frame(alpha= round(t(pfOut1_100[question1(),]),digits = 2),
                                 weight = t(wt_100[question1(),])))+
    geom_bar(stat = "identity",aes(x=alpha,y=weight)) +
    geom_vline(xintercept = sum(wt_100[question1(),] *
                                  pfOut1_100[question1(),]),color='blue')+
    geom_vline(xintercept = df$alpha[question0()],color='red')+
    xlim(-3.5,3.5)+ scale_y_continuous(labels=scaleFUN) 
  p2 <- ggplot(data = data.frame(alpha= round(t(pfOut1_1000[question1(),]),digits = 2),
    ...
    geom_vline(xintercept = df$alpha[question0()],color='red')+
    xlim(-3.5,3.5)+ scale_y_continuous(labels=scaleFUN) 
  p3 <- ggplot(data = data.frame(alpha= round(t(pfOut1_10000[question1(),]),digits = 2),
